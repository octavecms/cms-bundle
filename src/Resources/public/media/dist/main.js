...
},{"./vendor/jquery.ui.widget":2,"jquery":213}],2:[function(require,module,exports){
...
},{"jquery":213}],3:[function(require,module,exports){
...
var MediaGridListItem = function () {
    _createClass(MediaGridListItem, null, [{
        key: 'defaultOptions',
        get: function get() {
            return {
                'store': null
    ...
    function MediaGridListItem($container, options) {
        _classCallCheck(this, MediaGridListItem);
    ...
    _createClass(MediaGridListItem, [{
        key: 'init',
        value: function init() {
        ...
        value: function handleClick(e) {
            ...
            if ((e.metaKey || e.ctrlKey) && state.multiselect) {
                ...
                store.dispatch((0, _actions.toggleSelectedListItem)(id));
                store.dispatch((0, _actions.setOpenedListItem)(null));
            } else if (e.shiftKey && state.multiselect) {
                // Selecting multiple consecutive files
                var files = state.categories[state.categoryId] || [];
                var lastSelected = files[0];
                var selected = [id];
                var started = false;
                var ended = false;

                for (var _id in state.selected) {
                ...
                store.dispatch((0, _actions.addSelectedListItems)(selected));
                store.dispatch((0, _actions.setOpenedListItem)(null));
            } else {
                // Toggle opened item
                store.dispatch((0, _actions.setSelectedListItem)(id));
                store.dispatch((0, _actions.toggleOpenedListItem)(id));
            }
        }
    }, {
        ...
        value: function handleSelectedChange(selected, prevSelected) {
            if (!this.options) return;
            var id = this.options.id;

            var wasSelected = !!prevSelected[id];
        ...
        key: 'handleDraggingChange',
        value: function handleDraggingChange(dragging) {
            if (!this.options) return;
            var id = this.options.id;
    ...
    return MediaGridListItem;
}();

exports.default = MediaGridListItem;

},{"../modules/actions":215,"./uploader":211,"lodash/each":159,"lodash/map":183}],209:[function(require,module,exports){
'use strict';
...
var _gridlistItem = require('./gridlist-item');

var _gridlistItem2 = _interopRequireDefault(_gridlistItem);
...
var MediaGridList = function () {
    _createClass(MediaGridList, null, [{
        key: 'defaultOptions',
        get: function get() {
            return {
    ...
    function MediaGridList($container, options) {
        _classCallCheck(this, MediaGridList);
    ...
    _createClass(MediaGridList, [{
        key: 'init',
        value: function init() {
            var $container = this.$container;
            var options = this.options;
            var store = this.store = options.store;
            ...
            $container.selectable({}).on('selectableselecting.' + namespace, this.handleSelectItem.bind(this)).on('selectableselected.' + namespace, this.handleSelectItem.bind(this)).on('selectableunselecting.' + namespace, this.handleUnselectItem.bind(this)).on('selectableunselected.' + namespace, this.handleUnselectItem.bind(this));

            this.unsubscribers = [store.subscribePath('grid.files', this.handleGridChange.bind(this)), store.subscribePath('grid.loading', this.handleGridLoading.bind(this)), store.subscribePath('files', this.handleFilesChange.bind(this))];
        }
    }, {
        key: 'destroy',
        value: function destroy() {
        ...
        value: function handleGridChange(newFiles, prevFiles) {
            ...
            var added = (0, _reduce2.default)((0, _difference2.default)(newFiles, prevFiles), function (list, id) {
                list[id] = 1;return list;
            }, {});
            var removed = (0, _reduce2.default)((0, _difference2.default)(prevFiles, newFiles), function (list, id) {
                list[id] = 1;return list;
            }, {});

            // List of all files
            var files = (0, _filter2.default)((0, _uniq2.default)([].concat(newFiles, prevFiles)));
            var items = this.mediaGridItems;
            var prevItem = void 0;
        ...
        key: 'handleGridLoading',
        value: function handleGridLoading(loading) {
        ...
        value: function handleUnselectAllItems(e) {
        ...
        key: 'handleCloseListItem',
        value: function handleCloseListItem(e) {
            var id = this.getItemId(e);
        ...
        key: 'handleCloseListItemKey',
        value: function handleCloseListItemKey(e) {
            if (e.which == 27 && !$(e.target).is('input, select, textarea')) {
                // Escape key
                this.store.dispatch((0, _actions.setOpenedListItem)(null));
            }
        }
...
},{"../modules/actions":215,"../utils/micro-template":222,"./gridlist-item":208,"lodash/difference":158,"lodash/each":159,"lodash/filter":161,"lodash/reduce":187,"lodash/uniq":194}],210:[function(require,module,exports){
'use strict';
...
var MediaTreeView = function () {
    _createClass(MediaTreeView, null, [{
        key: 'defaultOptions',
        get: function get() {
            return {
    ...
    function MediaTreeView($container, options) {
        _classCallCheck(this, MediaTreeView);
    ...
    _createClass(MediaTreeView, [{
        ...
        value: function init() {
            ...
            this.unsubscribers = [store.subscribePath('categoryId', this.handleCategoryChange.bind(this)), store.subscribePath('tree.folders', this.handleFolderChange.bind(this))];
        ...
        value: function destroy() {
            ...
            $container.off('.' + namespace);
            $container.find(this.options.itemSelector).each(function (index, item) {
                _this.cleanupItem($(item));
            });
        ...
        value: function handleCategoryChange(categoryId) {
            this.$container.find(this.options.itemSelector).removeClass('is-active').filter('[data-id="' + encodeURIComponent(categoryId) + '"]').addClass('is-active');
        }
    }, {
        ...
        key: 'cleanupDroppable',
        value: function cleanupDroppable($element) {
        ...
        value: function cleanupItem($item) {
            ...
            _uploader2.default.unregisterDropZone($item);
        }
    }]);
...
},{"../modules/actions":215,"../utils/folders":221,"../utils/micro-template":222,"./uploader":211,"lodash/difference":158,"lodash/each":159,"lodash/map":183}],211:[function(require,module,exports){
'use strict';
...
var Uploader = function () {
    ...
    _createClass(Uploader, [{
        ...
        value: function handleFileSubmit(e, data) {
        ...
        value: function unregisterButton($element) {
            $element.removeClass('media-upload-button').find('input').off('change').remove();
        }
    }]);
...
},{"../modules/actions":215,"blueimp-file-upload":1}],212:[function(require,module,exports){
'use strict';
...
},{"jquery":213}],213:[function(require,module,exports){
"use strict";
...
$(function () {
    $('[data-widget="media"]').media();
});

},{"./lib/jquery.clean-data":212,"./modules/media":217}],215:[function(require,module,exports){
'use strict';
...
exports.unsetSelectedListItem = unsetSelectedListItem;
exports.unsetAllSelectedListItems = unsetAllSelectedListItems;
exports.setSelectedListItem = setSelectedListItem;
exports.toggleSelectedListItem = toggleSelectedListItem;
exports.addSelectedListItems = addSelectedListItems;
exports.setOpenedListItem = setOpenedListItem;
...
var SET_GRID_LIST = exports.SET_GRID_LIST = 'SET_GRID_LIST';
var SET_GRID_LOADING = exports.SET_GRID_LOADING = 'SET_GRID_LOADING';

var SET_DRAGGING_ITEMS = exports.SET_DRAGGING_ITEMS = 'SET_DRAGGING_ITEMS';
var DELETE_SELECTED_ITEMS = exports.DELETE_SELECTED_ITEMS = 'DELETE_SELECTED_ITEMS';
var UNSET_SELECTED_ITEM = exports.UNSET_SELECTED_ITEM = 'UNSET_SELECTED_ITEM';
var SET_SELECTED_ITEM = exports.SET_SELECTED_ITEM = 'SET_SELECTED_ITEM';
var TOGGLE_SELECTED_ITEM = exports.TOGGLE_SELECTED_ITEM = 'TOGGLE_SELECTED_ITEM';
var ADD_SELECTED_ITEMS = exports.ADD_SELECTED_ITEMS = 'ADD_SELECTED_ITEMS';
var REMOVE_SELECTED_ITEMS = exports.REMOVE_SELECTED_ITEMS = 'REMOVE_SELECTED_ITEMS';
...
function setSelectedItem(id) {
    return { type: SET_SELECTED_ITEM, id: id };
}

function toggleSelectedItem(id) {
    return { type: TOGGLE_SELECTED_ITEM, id: id };
}

function addSelectedItems(ids) {
    return { type: ADD_SELECTED_ITEMS, ids: ids };
}

function removeSelectedItems(ids) {
    return { type: REMOVE_SELECTED_ITEMS, ids: ids };
}
...
function fetchFilesIfNeeded(categoryId) {
...
function setGridLoading(loading) {
    return { type: SET_GRID_LOADING, loading: loading };
};

function setGridList(ids) {
    return { type: SET_GRID_LIST, ids: ids };
};

function unsetSelectedListItem(id) {
    return { type: UNSET_SELECTED_ITEM, id: id };
};

function unsetAllSelectedListItems() {
...
function toggleSelectedListItem(id) {
    return { type: TOGGLE_SELECTED_ITEM, id: id };
};

function addSelectedListItems(ids) {
    return { type: ADD_SELECTED_ITEMS, ids: ids };
};

function setOpenedListItem(id) {
    return { type: SET_OPENED_ITEM, id: id };
};

function toggleOpenedListItem(id) {
    return { type: TOGGLE_OPENED_ITEM, id: id };
};

function setCategory(id) {
    return { type: SET_CATEGORY, id: id };
};

function setDraggingListItems(ids) {
...
},{"../utils/folders":221,"lodash/each":159,"lodash/map":183,"lodash/uniq":194}],216:[function(require,module,exports){
'use strict';
...
function transformTreeBranch(folders) {
    ...
    (0, _map2.default)(folders, function (folder) {
        folderList.push(folder);

        if (folder.children) {
            folderList.push.apply(folderList, _toConsumableArray(transformTreeBranch(folder.children)));
            folder.children = (0, _map2.default)(folder.children, function (folder) {
                return folder.id;
            });
        }
    });
...
function transformTreeRoot(state) {
    if (state.tree.root) {
        var folders = state.tree.folders.concat(transformTreeBranch([state.tree.root]));
        state.tree.folders = (0, _reduce2.default)(folders, function (list, folder) {
            list[folder.id] = folder;return list;
        }, {});
...
},{"lodash/map":183,"lodash/reduce":187}],217:[function(require,module,exports){
'use strict';
...
var SELECTOR_MEDIA_UPLOAD_FILE = '.js-media-upload-file';
var SELECTOR_MEDIA_REMOVE = '.js-media-remove';
var SELECTOR_MEDIA_SELECT_OPENED = '.js-media-select-opened';
var SELECTOR_MEDIA_SELECT_ALL = '.js-media-select-all';
var SELECTOR_ADD_FOLDER = '.js-media-add-folder';
var SELECTOR_TREE_VIEW = '[data-widget="media-treeview"]';
var SELECTOR_GRID_LIST = '[data-widget="media-gridlist"]';

var MediaStandalone = function () {
    _createClass(MediaStandalone, null, [{
        key: 'defaultOptions',
        get: function get() {
            return {
    ...
    function MediaStandalone(element, options) {
        _classCallCheck(this, MediaStandalone);
    ...
    _createClass(MediaStandalone, [{
        key: '_init',
        value: function _init() {
            var store = this.store = (0, _store2.default)({ 'multiselect': this.options.multiselect });
            var $element = this.$element;

            // @TODO Remove, this is for debug only
            window.store = store;

            var $treeView = this.$treeView = $element.find(SELECTOR_TREE_VIEW);
            this.treeView = new _treeview2.default($treeView, { 'store': store });

            var $gridList = this.$gridList = $element.find(SELECTOR_GRID_LIST);
            this.gridList = new _gridlist2.default($gridList, { 'store': store });
            ...
            // Upload
            _uploader2.default.registerButton($element.find(SELECTOR_MEDIA_UPLOAD_FILE), this._getUploaderInfo());
            _uploader2.default.registerDropZone($gridList, this._getUploaderInfo());
            ...
            // Load grid info
            store.dispatch((0, _actions.fetchFilesIfNeeded)(this._getCurrentFolderId()));
        }
    }, {
        key: '_getCurrentFolderId',
        value: function _getCurrentFolderId() {
            return this.store.getState().categoryId;
        }
    }, {
        key: '_getUploaderInfo',
        value: function _getUploaderInfo() {
            var _this = this;

            return {
                'info': function info() {
                    return {
                        'parent': _this._getCurrentFolderId()
                    };
                }
            };
        }
        ...
        value: function _handleRemoveClick() {
            this.store.dispatch((0, _actions.deleteSelectedListItems)());
        }
    }, {
        key: '_handleAddFolderClick',
        value: function _handleAddFolderClick() {
            var name = prompt('Enter name of the folder');
            var parent = this._getCurrentFolderId();
            this.store.dispatch((0, _actions.addFolder)(name, parent));
        }
    }, {
        key: '_handleCategoryChange',
        value: function _handleCategoryChange() {
            var state = this.store.getState();
            var list = state.categories[state.categoryId];

            if (list) {
                this.store.dispatch((0, _actions.setGridList)([].concat(list)));
            }
        }
    }, {
        key: '_handleItemDoubleClick',
        value: function _handleItemDoubleClick(e) {
            if (this.options.selectmode && typeof this.options.onselect === 'function') {
                var id = this.gridList.getItemId(e);
        ...
        key: '_handleSelectOpenedClick',
        value: function _handleSelectOpenedClick() {
            if (typeof this.options.onselect === 'function') {
                var state = this.store.getState();
                var files = state.opened ? [state.files[state.opened]] : [];

                this.options.onselect(files);
            }
        }
    }, {
        key: '_handleSelecAllClick',
        value: function _handleSelecAllClick() {
            if (typeof this.options.onselect === 'function') {
                var state = this.store.getState();
                var files = (0, _map2.default)(state.selected, function (value, id) {
        ...
        key: 'destroy',
        value: function destroy() {
            _uploader2.default.unregisterButton(this.$element.find(SELECTOR_MEDIA_UPLOAD_FILE));
            _uploader2.default.unregisterDropZone(this.$gridList);
    ...
    return MediaStandalone;
}();

$.bridget(MEDIA_NAMESPACE, MediaStandalone);

},{"../components/gridlist":209,"../components/treeview":210,"../components/uploader":211,"../modules/actions":215,"../modules/store":219,"lodash/map":183}],218:[function(require,module,exports){
'use strict';
...
function gridReducer(state, action) {
    switch (action.type) {
        case _actions.SET_GRID_LIST:
            return (0, _setImmutable2.default)(state, 'grid.files', action.ids || []);
        case _actions.SET_GRID_LOADING:
            return (0, _setImmutable2.default)(state, 'grid.loading', action.loading);
        default:
            return state;
    }
}
...
function dragReducer(state, action) {
    switch (action.type) {
        case _actions.SET_DRAGGING_ITEMS:
            return (0, _setImmutable2.default)(state, 'grid.dragging', action.ids);
        default:
            return state;
    }
}
...
function selectedReducer(state, action) {
    ...
    switch (action.type) {
        ...
        case _actions.SET_SELECTED_ITEM:
            ...
            return (0, _setImmutable2.default)(state, 'selected', selected);
        case _actions.TOGGLE_SELECTED_ITEM:
            var isSelected = state.selected[action.id];
            return (0, _setImmutable2.default)(state, ['selected', action.id], isSelected ? 0 : 1);
        case _actions.ADD_SELECTED_ITEMS:
            selected = $.extend({}, state.selected);

            selected = (0, _reduce2.default)(action.ids, function (selected, id) {
                selected[id] = 1;
                return selected;
            }, selected);

            return (0, _setImmutable2.default)(state, 'selected', selected);
        case _actions.REMOVE_SELECTED_ITEMS:
            selected = $.extend({}, state.selected);
            ...
            return (0, _setImmutable2.default)(state, 'selected', selected);
        case _actions.UNSET_ALL_SELECTED_ITEMS:
            return (0, _setImmutable2.default)(state, 'selected', {});
        default:
            return state;
    }
...
function openedReducer(state, action) {
    switch (action.type) {
        case _actions.SET_OPENED_ITEM:
            return (0, _setImmutable2.default)(state, 'opened', action.id);
        case _actions.TOGGLE_OPENED_ITEM:
            return (0, _setImmutable2.default)(state, 'opened', state.opened === action.id ? null : action.id);
        default:
            return state;
    }
};
...
function categoryReducer(state, action) {
    switch (action.type) {
        case _actions.SET_CATEGORY:
            state = (0, _setImmutable2.default)(state, 'opened', null);
            state = (0, _setImmutable2.default)(state, 'selected', {});
            state = (0, _setImmutable2.default)(state, 'categoryId', action.id);
...
function fileReducer(state, action) {
    ...
    switch (action.type) {
        ...
        case _actions.RECEIVE_FILES:
            ...
            state = (0, _setImmutable2.default)(state, ['categories', action.categoryId], (0, _map2.default)(action.files, function (file) {
                return file.id;
            }));
...
exports.default = function (state, action) {
    return (0, _reduce2.default)([gridReducer, dragReducer, selectedReducer, openedReducer, categoryReducer, folderReducer, fileReducer], function (state, reducer) {
        return reducer(state, action);
    }, state);
};

},{"../utils/remove-immutable":223,"../utils/set-immutable":224,"./actions":215,"lodash/filter":161,"lodash/find":162,"lodash/findIndex":163,"lodash/map":183,"lodash/reduce":187,"lodash/uniq":194,"lodash/without":195}],219:[function(require,module,exports){
'use strict';
...
exports.default = function (state) {
    var store = (0, _redux.createStore)(_reducers2.default, (0, _getInitialState2.default)(state), (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
var _getInitialState = require('./get-initial-state');
...
var storeExtensions = {
    subscribePath: function subscribePath(path, callback) {
        var _this = this;

        var store = this;
        var value = (0, _get2.default)(this.getState(), path);

        return this.subscribe(function () {
            var newvalue = (0, _get2.default)(_this.getState(), path);
            if (newvalue !== value) {
                var prevvalue = value;
                value = newvalue;
...
},{"./get-initial-state":216,"./reducers":218,"lodash/get":165,"redux":203,"redux-thunk":197}],220:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
var REGEX_AMPESTRAND = /&/g;
var REGEX_QUOTE = /"/g;
var REGEX_APOS = /'/g;
var REGEX_LT = /</g;
var REGEX_GT = />/g;
...
exports.default = {
    ...
    html: function html(text) {
        ...
        return str.replace(REGEX_AMPESTRAND, CHAR_AMPESTRAND).replace(REGEX_APOS, CHAR_APOS).replace(REGEX_QUOTE, CHAR_QUOTE).replace(REGEX_LT, CHAR_LOWER).replace(REGEX_GT, CHAR_GREATER);
    },
...
function tmpl(str, data) {
    ...
    new Function("vars", "var p=[],escape=$.escape,print=function(){p.push.apply(p,arguments);};" +
...
},{"./escape":220}],223:[function(require,module,exports){
'use strict';
...
},{"lodash/clone":156,"lodash/has":166,"lodash/isArray":170}],224:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.default = setImmutable;
...
function setImmutable(source, keyString, value) {
    var keys = (0, _isArray2.default)(keyString) ? keyString : keyString.split('.');
    var cloned = $.extend({}, source);
    var object = cloned;

    for (var i = 0; i < keys.length; i++) {
        object[keys[i]] = i == keys.length - 1 ? value : (0, _clone2.default)(object[keys[i]]);
        object = object[keys[i]];
    }
...
},{"lodash/clone":156,"lodash/isArray":170}]},{},[214])
