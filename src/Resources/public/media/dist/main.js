...
var MediaGridList = function () {
    ...
    _createClass(MediaGridList, [{
        ...
        value: function init() {
            ...
            $container.selectable({}).on('selectableselecting', this.handleSelectItem.bind(this)).on('selectableselected', this.handleSelectItem.bind(this)).on('selectableunselecting', this.handleUnselectItem.bind(this)).on('selectableunselected', this.handleUnselectItem.bind(this));
...
exports.default = transformTreeRoot($.extend(true, {
    'tree': {
...
$(function () {
    function handleCategoryChange(nextValue, prevValue) {
        ...
        if (list) {
            store.dispatch((0, _actions.setGridList)([].concat(list)));
        }
    }
    ...
    store.dispatch((0, _actions.fetchFilesIfNeeded)(store.getState().categoryId));
});
